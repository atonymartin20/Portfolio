...
class ProjectCardList extends React.Component {
    state = {
        ...
        angularProjects: [
            { id: 1, name: 'Hero Game', github: 'https://github.com/atonymartin20/hero-game', deployedLink: 'https://hero-game-adm.netlify.app/', description: 'Hero Game is a basic hero fighting game.  You can create and edit heros and then fight against other heroes.', additionalInfo: './projectInfoPages/HeroGame' }
        ],
        reactProjects: [
            ...
            { id: 4, name: 'Invoice App', github: 'https://github.com/atonymartin20/invoice-app', deployedLink: 'https://invoice-app-adm.netlify.app/', description: "Invoice App is an invoice tracker that can keep track of a company's invoices and easily show all active invoices.", additionalInfo: './projectInfoPages/InvoiceApp' },
        ...
        vueJSProjects: [
            { id: 1, name: 'tip-calc', github: 'https://github.com/atonymartin20/tip-calc', deployedLink: 'https://tip-calc-adm.netlify.app/#/', description: 'Tip-calc is a simple tool that allows users to divide a bill easily.', additionalInfo: './projectInfoPages/TipCalc' },
        ],
    };
                    ...
                    <Grid container spacing={5}>
                        <Grid item xs={12}>
                            <Grid container justify="center" spacing={5}>
                                {this.state.soloFullstackProjects.map(project => (
            ...
            return (
                <div className={classes.content}>
                    <Grid container spacing={5}>
                        <Grid item xs={12}>
                            <Grid container justify="center" spacing={5}>
                                {this.state.angularProjects.map(project => (
                                    <Grid key={project.id} item>
                                        <ProjectCard
                                            id={project.id}
                                            name={project.name}
            ...
            return (
                <div className={classes.content}>
                    <Grid container spacing={5}>
                        <Grid item xs={12}>
                            <Grid container justify="center" spacing={5}>
                                {this.state.vueJSProjects.map(project => (
                                    <Grid key={project.id} item>
                                        <ProjectCard
                                            id={project.id}
                                            name={project.name}
